  ...
  function togpx( geojson, options ) {
    ...
    features.forEach(function mapFeature(f) {
      ...
      case "MultiLineString":
        ...
        coords.forEach(function(coordinates) {
          ...
          coordinates.forEach(function(c, i) {
            ...
            if (current_seg != segment){
              ...
              o.trkseg.push(seg);
              seg = {trkpt: []};
              // add roughness of new segment
              rough = current_rough;
              rough_array += current_rough;
              rough_array += ',';
            }
            // add 1st segment's roughness
            if (i == 0){
              rough_array += current_rough;
              rough_array += ',';
              rough = current_rough;
        ...
        // assign stringified oughness array to object
        rough_array = rough_array.substring(0,rough_array.length-1) + ']';
        o.roughness = rough_array;
        gpx.gpx.trk.push(o);
        break;
